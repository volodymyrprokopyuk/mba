...
que las respuestas del sistema tienen que ser correctas independientemente de
las condiciones en que trabaja el sistema. El nivel de carga, el tiempo de
respuesta de otros subsistemas con los cuales está conectado el sistema de deben
influir en el resultados final de las respuesta del sistema. La empresa ofrece
las soluciones con la máxima fiabilidad mediante la aplicación de los métodos de
...
software que permiten construir los sistemas altamente disponibles con el mínimo
...
ingresos por las ventas de las soluciones IT y de los servicios de consultoría
IT se establecen los siguientes objetivos:
\startitemize
...
\HL
\NC \use{2}{\bf\Gray Actividades de financiación\hfill} \NC\MR
% Financing activity
