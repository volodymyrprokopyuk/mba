...
\section{Business idea (Business model summary) (chapter 2)}
...
\section{List of key products/services}
...
\subsection{Operations (produce products and provide services)}
...
\section{Growth strategy (potential)}
...
\chapter{Contingency plan (what if ...?)}
