...
\startFLOWcell
  \name{flow}
  \location{1,1}
  \text{Flow Volodymyr Prokopyuk Vorokhta and Svitlana}
  \shape{5}
  \connection[rl]{chart}
\stopFLOWcell
\startFLOWcell
...
\setupFLOWcharts[width=10\bodyfontsize,height=4\bodyfontsize]
\startFLOWchart[chart:mision]
\startFLOWcell
  \name{flow}
  \location{1,1}
  \text{\bf\Base Flow Volodymyr Prokopyuk Vorokhta and Svitlana}
  \shape{5}
  \connection[rl]{chart}
\stopFLOWcell
\startFLOWcell
...
\Paragraph{Compromiso con la caliad y la mejora continua}
...
\Paragraph{Servicios personalizados de calidad de consultoría \AwRArrowLong\
...
La tercera línea de las actividades de I+D se dedica a la gestión de proyectos.
...
agilizar tales etapas del proyecto como la gestión de clientes, la toma de
...
metodologías ágiles de gestión de proyectos, la gestión de tiempo, optimización
...
\item Mantenimiento de las soluciones
\stopitemize
...
\Paragraph{Mantenimiento de las soluciones}
...
estratégicas y tácticas voy a tomar yo. La dirección de la empresa es enfocada
...
con la innovación y la relación calidad/precio superior.
...
\startitemize
\item Crear producto IT nuevos para fortalecer la posición de la empresa en el
mercado
\item Conseguir los clientes nuevos
\item Fortalecer las relaciones con los clientes potenciales
...
utilizando la \in{tabla}[coste-hora].
...
clientes:
\startitemize
\item Desarrollo e impalntación de las soluciones IT para el negocio de los
clientes
\item Los servicios de consultoría IT para la orientación y selección de las
tecnologías IT más apropiadas para los clientes
\item Mantenimiento y modificación de las soluciones IT de los clientes
...
La empresa se posiciona en el mercado como {\bf\Gray La empresa de soluciones IT
de calidad personalizadas y los servicios de consultoría IT para las empresas
...
\in{tabla}[coste-hora]. La empresa utiliza el método de asignar los precios
