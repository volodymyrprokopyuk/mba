...
desarrollo de software como los servicios de consultoria IT. La situación y las
...
\Comment{Los principios que guian la actividad de la empresa}
...
\subsection{Resumen de los productos y servicios}%{Products and services summary}
...
emrpesa. Las tendencias favorambles en la industria son:
\startitemize
\item Avances tecnológicos en la virtualización de hardware permiten reducir los
costes de hardware de los servidores que utiliza la empresa
\item Crecimiento de la nube promueve las plataformas de bajo coste de despliege
...
\item Compromiso con la caliad y la mejora contínua
...
empresa no disponde de la cartede de clientes. La empresa tampoco tiene los
...
clientes potenciales con el cobejetivo de firmas los contratos de desarrollo de
las soluciones IT.
...
\item Ofrecer a los clientes los productos IT con la ralación calidad/precio
