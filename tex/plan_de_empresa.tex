...
\section{Análisis de punto de equilibrio}%{Break-even analysis}
...
\stopfact
\startformula
US = \frac{CFT}{PU - CVU} = \frac{35}{1000 - 5}~\cdot~5~días/sem~\cdot~8~horas/día \approx 1.5~horas/semana
\stopformula
...
\item Ingresos - gastos en un período
\stopitemize
...
\HL
\NC Intereses% Interest income/expenses
  \NC - 0 euros \NC\MR
...
\startitemize
\item Análisis patrimonial y financiero
\item Situación partimonial en un momento
\item Exigibilidad \endash\ proximidad de vencimiento de deuda (pasivos)
\item Liquidez \endash\ proximidad de conversión en dinero (activos)
\stopitemize
...
\NC \hspace[big] Electricidad \NC - 240 euros \NC\MR
\NC \hspace[big] Internet \NC - 420 euros \NC\MR
\NC \hspace[big] Amortizaciones (portátil) \NC - 120 euros \NC\MR
\NC \hspace[big] Impuestos \NC - 12 405 euros \NC\MR
...
\HL
\NC \hspace[big] Capital \NC 3 700 euros \NC\MR
\NC \hspace[big] Reservas \NC 37 215 euros \NC\MR
...
\startitemize
\item Capacidad de la emrepsa de generar la riqueza
\item Salto positivo \endash\ autofinanciación
\stopitemize
